...
urlpatterns = [
    ...
    path('groupes/<int:pk>/verrouiller/', views.verrouiller_groupe_ticket, name='verrouiller-groupe-ticket'),
    path('groupes/<int:pk>/deverrouiller/', views.deverrouiller_groupe_ticket, name='deverrouiller-groupe-ticket'),
]
